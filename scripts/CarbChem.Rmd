...
TukeyHSD(res.aov) # Significant differences in all treatment comparisons
...
TukeyHSD(res.aov) # no significant differences in all treatment comparisons
...
summary(res.aov) # significant differences between treatments
TukeyHSD(res.aov) # Significant differences between high and control/mid treatment 
