...
ggsave("../output/functional_enrichment/Downregulated_shared_genes_WithErrorBars.pdf", shared_down_error, width = 15, height = 14)
ggsave("../output/functional_enrichment/Downregulated_shared_genes_WithErrorBars.png", shared_down_error, width = 15, height = 14)
```
